...
const adminCustomers_1 = __importDefault(require("./routes/adminCustomers"));
...
app.use("/api/v1/admin/customers", adminCustomers_1.default);
app.use("/api/v1/admin/products", adminProducts_1.default);
exports.default = app;
