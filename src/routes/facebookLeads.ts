...
import {
  searchFacebookLeads,
} from "../services/facebookLeads.js";

import type {
  FacebookSearchType,
} from "../types/facebookLeads.js";

const router = Router();

const ALLOWED_SEARCH_TYPES: FacebookSearchType[] = [
  "people",
  "pages",
  "places",
  "events",
  ...
  async (req, res) => {
    try {
      ...
      return res.status(200).json({
        success: true,
        message:
          "Facebook search completed successfully.",
        data: leads,
      });
    } catch (error) {
      console.error(
